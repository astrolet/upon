  ...
  CelestialLongitude = (function(_super) {
    ...
    CelestialLongitude.prototype.dms = function() {
      ...
      if (_.isString(this.aligns)) {
        if (this.aligns.length > 1) {
          this.aligns = this.aligns.charAt(0);
        }
        if (d < 10) {
          d = "" + this.aligns + d;
        }
    ...
    CelestialLongitude.prototype.rep = function(more) {
      var a, d, m, rep, rest, s, _ref, _ref1;
      ...
      switch (more) {
        ...
        case "str":
          ...
          _ref1 = degrees.lon(rest).align(a).dms(), d = _ref1[0], m = _ref1[1], s = _ref1[2];
